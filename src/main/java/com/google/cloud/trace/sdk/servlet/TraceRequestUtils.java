...
public class TraceRequestUtils {
   ...
   */
  private static long getParentSpanId(HttpServletRequest request) {
   ...
   */
  public static TraceSpanDataHandle createRequestSpanData(TraceWriter writer,
      HttpServletRequest request, String projectId) {
    TraceSpanDataHandle spanDataHandle = new TraceSpanDataHandle(writer, projectId,
        getTraceId(request), getFullURL(request), getParentSpanId(request));
   ...
   */
  public static TraceSpanDataHandle getRequestSpanDataHandle(HttpServletRequest req) {
