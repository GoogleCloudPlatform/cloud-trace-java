...
/**
 * Names a new {@link TraceSpanData}s after the URI component of the request.
 * Leaves off the query string and (per getRequestURI) the server name/port/protocol.
 */
public class URIRequestTraceSpanNamingStrategy implements RequestTraceSpanNamingStrategy {
  /**
